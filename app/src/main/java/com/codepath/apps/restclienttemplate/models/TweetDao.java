...
public interface TweetDao {
    ...
    @Query("SELECT Tweet.body AS tweet_body, Tweet.createdAt AS tweet_createdAt, Tweet.id AS tweet_id," +
            "Tweet.userId AS tweet_userId, Tweet.retweets AS tweet_retweets, Tweet.likes AS tweet_likes," +
            "Tweet.liked AS tweet_liked, Tweet.retweeted AS tweet_retweeted, User.* " +
